    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
      ...
      <div className="mt-8 space-y-8 text-sm text-muted-foreground leading-relaxed">
        ...
        <section>
          ...
          <p className="mt-3">
            We do not collect, store, or have access to your full card number, CVV, or other sensitive payment card data. All payment card information is handled directly by Paystack (a Stripe company) on their secure infrastructure.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="mt-3 list-disc pl-5 space-y-2">
            <li><strong className="text-gray-700">Paystack / Stripe:</strong> Payment processing services used to collect your payment for transfers.</li>
