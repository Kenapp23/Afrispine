    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
      ...
      <div className="mt-8 space-y-8 text-sm text-muted-foreground leading-relaxed">
        ...
        <section>
          ...
          <p>
            All payments made through the AfriSpine platform are processed by Paystack Ltd, a Stripe company and a licensed payment service provider. When you enter your card details, you are interacting directly with Paystack&apos;s secure payment infrastructure. AfriSpine does not store, process, or have access to your full card number, CVV, or other sensitive card data.
          </p>
          <p className="mt-3">
            By making a payment through AfriSpine, you also agree to be bound by Paystack&apos;s Terms of Service, which are available on Paystack&apos;s website. Any disputes relating to card charges, payment authorisation, or payment security are governed by Paystack&apos;s terms and applicable payment network rules.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3">
            Refund requests must be submitted within twenty-four (24) hours of the failed or erroneous transfer. Refunds are processed back to the original payment method via Paystack and typically take between five (5) and ten (10) business days to appear in your account, depending on your bank or card issuer&apos;s processing times.
          </p>
          <p className="mt-3">
