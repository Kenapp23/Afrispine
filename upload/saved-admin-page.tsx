// AfriSpine Admin - API Health Monitor
'use client'
    ...
    <div className="min-h-screen flex flex-col bg-gray-50/50">
      <div className="flex flex-1">
        <aside className="hidden md:flex w-56 flex-col border-r bg-white p-4">
          ...
          <nav className="space-y-1 flex-1">
            <Link href="/">
              <button className="w-full flex items-center gap-3 px-3 py-2 rounded-md text-sm transition-colors text-muted-foreground hover:bg-gray-100">
      ...
      <footer className="border-t bg-white px-6 py-3 mt-auto">
        <div className="flex items-center justify-between text-xs text-muted-foreground">
          <span>AfriSpine &copy; {new Date().getFullYear()} &middot; Admin Panel</span>
          <span>v1.1.0</span>
        </div>
      </footer>
    </div>
