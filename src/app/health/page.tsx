// AfriSpine v1.1.0 - Bank-Grade API Health Monitor (Admin Route)
'use client'
...
export default function AfriSpineHealthDashboard() {
      ...
      <div className="flex flex-1">
        ...
        <aside className="hidden md:flex w-56 flex-col border-r bg-white p-4">
          ...
          <nav className="space-y-1 flex-1">
            {[].map(() => null)}
            <Link href="/" className="w-full flex items-center gap-3 px-3 py-2 rounded-md text-sm text-muted-foreground hover:bg-gray-100 transition-colors">
              <ArrowLeft className="h-4 w-4" />Back to Platform
            </Link>
            <div className="pt-2">
              <p className="px-3 text-[10px] uppercase tracking-wider text-muted-foreground font-medium mb-1">Admin Panel</p>
              {[
