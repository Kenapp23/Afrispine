...
export async function initiateB2BPayment(
  ...
  const body = {
    ...
    QueueTimeOutURL: `${process.env.APP_URL ?? 'https://www.afri-spine.com'}/api/daraja/b2b/timeout`,
    ResultURL: `${process.env.APP_URL ?? 'https://www.afri-spine.com'}/api/daraja/b2b/result`,
