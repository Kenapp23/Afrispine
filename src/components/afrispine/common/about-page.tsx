    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
      ...
      <div className="mt-8 space-y-10 text-sm text-muted-foreground leading-relaxed">
        ...
        <section>
          ...
          <p className="mt-3">
            We are not a bank or money transmitter. Your payment is collected securely by Eversend and delivered by our licensed provider partners including regulated mobile money operators and banks. AfriSpine earns a transparent service fee of 1–3% per transfer. Your principal is never in our hands.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="mt-3 space-y-3">
            ...
            <li className="flex gap-3">
              ...
              <span>Eversend (licensed payment service provider) processes your card payment. We never see or store your full card details.</span>
            </li>
            <li className="flex gap-3">
